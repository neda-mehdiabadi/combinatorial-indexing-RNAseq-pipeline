...
#pData(cds) = merge(pData(cds), hash_df_all,  by = "Cell")
#rownames(pData(cds)) <- cds@colData@listData[["Cell"]]




#saveRDS(object = cds, file = paste(output.dir, "/", "cds.RDS", sep = ""))
saveRDS(object = hash_df_all,
        file = paste(output.dir, "/", "hash_df_all.RDS", sep = ""))
